...
```bash
export SKILLS_ROOT="${CLAUDEWORK_SKILLS_ROOT:-${SKILLS_ROOT:-$HOME/Library/Application Support/ClaudeWork/SKILLs}}"
...
Installed skills resolve from `$CLAUDEWORK_SKILLS_ROOT` / `$SKILLS_ROOT` (production default: app `userData/SKILLs`, macOS usually `~/Library/Application Support/ClaudeWork/SKILLs`).
