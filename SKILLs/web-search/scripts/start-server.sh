...
ensure_npm_available() {
  ...
  echo "  Please reinstall the web-search skill runtime from ClaudeWork."
  return 1
}
...
if ! resolve_node_runtime; then
  ...
  echo "  Please install Node.js, or run from ClaudeWork so scripts can use Electron runtime."
  exit 1
fi
