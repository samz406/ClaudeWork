...
This guide walks through testing the entire Web Search Skill integration with ClaudeWork.

## Prerequisites

1. ClaudeWork built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with ClaudeWork.

**Steps:**

1. Start ClaudeWork in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of ClaudeWork launch.
...
1. Open a terminal while ClaudeWork is running
...
**Objective:** Verify graceful shutdown of services when ClaudeWork quits.

**Steps:**

1. With ClaudeWork running and searches completed, quit the application
...
1. Start ClaudeWork (ensure headless is false in config)
...
- ✅ Server auto-starts with ClaudeWork
