 ...
 *
 * Log file locations:
 *   macOS:   ~/Library/Logs/ClaudeWork/main.log
 *   Windows: %USERPROFILE%\AppData\Roaming\ClaudeWork\logs\main.log
 *   Linux:   ~/.config/ClaudeWork/logs/main.log
 */
...
export function initLogger(): void {
  ...
  // Log startup marker
  log.info('='.repeat(60));
  log.info(`ClaudeWork started (${process.platform} ${process.arch})`);
  log.info('='.repeat(60));
}
